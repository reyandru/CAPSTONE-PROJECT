...
<body>
  ...
  <div class="container">
    ...
    <main class="main">
      <div class="conts1">
        <div class="page"> 
          <p><img src="../assets/homes.png" alt="" height="15">Members</p>
        </div>
      ...
      <div class="conts2">
        <div class="checkinContainer">
          ...
          <div>
            <div class="header"><span>MEMBERS</span> <span>REGISTER DATE</span> <span>EXPIRY DATE</span></div>
          <div id="checkinRecords">
              <div class="recordEntry">
                  <div class="memberUsername dataField">Juan Dela Cruz</div>
                  <div class="checkinDate dataField">10/12/2024</div>
                  <div class="timeIn dataField">11/12/2024</div>
                  <div> <button class="updateTime">UPDATE</button></div>
                  <div> <button class="dltAccount">DELETE </button></div>
