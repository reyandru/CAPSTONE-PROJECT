...
$sql = "SELECT firstname, lastname, age, gender, address, contactNo, email FROM registerdb WHERE id = ?";
      ...
      <div class="left-container">
          <div class="userProfil">
              <a href="#">
                  ...
                  <p class="userName"><?php echo htmlspecialchars($row["firstname"]." ".$row["lastname"]); ?></p> 
              </a>
                  ...
                  <div id="profile">
                      ...
                      <div class="botConts">
                          ...
                          <div class="userAge user usersss">
                              <h3>Age:</h3>
                              <div id="userage" class="outpt"><?php echo htmlspecialchars($row['age']); ?></div>
                          </div>
                          <div class="userGender user users">
                              <h3>Gender:</h3>
                              <div id="usergender" class="outpt"><?php echo htmlspecialchars($row['gender']); ?></div>
                          </div>
                          <div class="userAddress user users">
                              <h3>Address:</h3>
                              <div id="useraddress" class="outpt"><?php echo htmlspecialchars($row['address']); ?></div>
                          </div>
                          <div class="userCn user">
                              <h3>Contact No:</h3>
                              <div id="usercontacts" class="outpt"><?php echo htmlspecialchars($row['contactNo']); ?></div>
                          </div>
                          <div class="userEmail user userss">
                              <h3>Email:</h3>
                              <div id="useremail" class="outpt"><?php echo htmlspecialchars($row['email']); ?></div>
                          </div>
                      </div>
                  </div>
              </div>
